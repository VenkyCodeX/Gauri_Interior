...
import {
  ...
  ChevronLeft, ChevronRight, LogOut, ArrowLeft, Play, Eye
} from 'lucide-react'
...
export default function VideoManager() {
  ...
  const startEdit = (v) => {
    setEditId(v._id)
    setEditData({ title: v.title || '', category: v.category || '' })
  }

  const saveEdit = async (id) => {
    try {
      await videoAPI.update(id, editData)
      ...
      <div className="sticky top-0 z-50 bg-[#0A0A0A]/95 backdrop-blur border-b border-white/5 px-4 sm:px-6 py-4 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <span className="text-white/30 text-xs ml-2">Video Manager</span>
          </div>
        </div>

        <div className="flex items-center gap-3">
          {/* Switch to Gallery Manager */}
          <button
            ...
            >
              ...
              >
                ...
                <p className="text-white/40 text-sm">
                  {uploading ? 'Uploading...' : isDragActive ? 'Drop videos here' : 'Drag & drop or click to select'}
                </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-center gap-6 mb-8 pb-6 border-b border-white/5">
          <div>
            ...
            <p className="text-white/30 text-xs tracking-wider uppercase">Total Videos</p>
          </div>
          ...
          >
            ...
            >
              {preview.videoUrl ? (
                ...
                <div className="w-full aspect-video bg-[#111] flex items-center justify-center text-white/20 text-sm">
                  Video not available
                </div>
              )}
